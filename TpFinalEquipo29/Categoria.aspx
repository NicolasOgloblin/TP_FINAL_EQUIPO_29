...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /><br />
    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Categoría" OnClick="btnAgregar_Click" CssClass="btn btn-outline-success" ValidationGroup="AgregarCategoria" />
    <br /><br />
