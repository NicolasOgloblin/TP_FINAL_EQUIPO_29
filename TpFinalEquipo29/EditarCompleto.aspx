...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvArticulos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
        OnRowEditing="gvArticulos_RowEditing" OnRowUpdating="gvArticulos_RowUpdatingFull"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Categoría">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblCategoriaId" runat="server" Text='<%# Eval("Categoria.Id") %>' Visible="false"></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Marca">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblMarcaId" runat="server" Text='<%# Eval("Marca.Id") %>' Visible="false"></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
