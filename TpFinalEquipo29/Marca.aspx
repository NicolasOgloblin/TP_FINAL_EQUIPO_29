<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Marca.aspx.cs" Inherits="TpFinalEquipo29.Marca" %>
...
<asp:GridView ID="gvMarcas" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" OnRowEditing="gvMarcas_RowEditing" OnRowUpdating="gvMarcas_RowUpdating" OnRowCancelingEdit="gvMarcas_RowCancelingEdit" OnRowDeleting="gvMarcas_RowDeleting" CssClass="table table-striped">
    <Columns>
